...
ActiveThreadsTable.prototype.refresh = function(methodName) {
    ...
    $.get(service("services/threads"), function(data){
        ...
        $(data).find("thread").each(function(){
            ...
            if (!(actionName=="getThreadInfos") &&
                ...
                row.push("<img class='threadImage' src='../images/list.png' style='cursor:pointer;margin-top:3px' threadName='" + threadName + "' onclick='ActiveThreadsTable._showDialog(\"" + threadName + "\");'/>" + currentTraceItem);
