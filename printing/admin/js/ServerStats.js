...
ServerStats.prototype.init = function() {
    var html = "" +
                  "<span style='padding-left:18px;'>Auto Refresh</span><img id='ServerStats_progress' src='../images/progress.gif' style='display:hidden;;padding-left:5px;width:13px;height:13px;'/>" +
...
ServerStats.prototype.refresh = function() {
    ...
    $.get(service("stats"), function(data){
